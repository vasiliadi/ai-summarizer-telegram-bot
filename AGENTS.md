...
6. **Never `git push` unprompted** — a `/create-pr` invocation or direct user request authorizes exactly one push. It does not create standing permission. Otherwise, commit locally and report the branch as ready.
