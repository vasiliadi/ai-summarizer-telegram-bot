...
Read sequentially. After each document, write a Source Document Summary (template in `agent-templates.md`) to disk. Then proceed with work using summaries only.
